...
if (isset($_POST['edit_product'])) {
    ...
    $query = "UPDATE products SET product_title = '$product_title' ,product_img1 ='$product_img1',product_img2 ='$product_img2',product_img3 ='$product_img3', product_desc = '$product_desc', product_info = '$product_info', product_price = '$product_price', promotion = '$promotion' , promo_price = '$promo_price'  WHERE product_id = $p_id ";
