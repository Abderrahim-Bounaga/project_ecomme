            ...
            <div class="container-fluid">
                ...
                <thead>
                    <tr>
                      ...
                      <tbody>
                      <?php 
                            $query = "SELECT * FROM slide  WHERE archif_slide = '0'" ;
                            ...
                            while ($row = mysqli_fetch_array($load_slides_query)) {
                                ...
                                echo "<td><img class= 'img-responsive' src='../img_slide/$slide_image' alt='' width='100' height='100'></td>";
                                echo "<td>$slide_desc</td>";
                                echo "<td> <a href='edit_slide.php?edit=$slide_id'>Edit</a></td>";
                                echo "<td><a href='view_slide.php?delete=$slide_id'>Delete</a></td>";
                                echo "</tr>";
                            }
                            ...
                            if (isset($_GET['delete'])) {
                                ...
                                $query_UPDATE = "UPDATE slide SET archif_slide = '1' WHERE id_slide = $deleted_slide_id";
