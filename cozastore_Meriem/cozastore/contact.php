...
if (isset($_POST['contact'])) {
	...
	try {
		...
		$alert = "<div class='alert alert-danger'>Message could not be sent. Mailer Error: {$mail->ErrorInfo}</div>";
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					...
					<form action ="contact.php" method = "post">
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							Send Us A Message <?php echo $alert; ?>
						</h4>
						...
						<button class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer" name="contact">
							Submit
						</button>
					</form>
				</div>
