...
if (isset($_POST['add_blog'])) {
    ...
    $add_blog = "INSERT INTO Blog (blog_title,blog_img,blog_info,blog_date,blog_desc) VALUES ('$blog_title','$blog_img','$blog_info',NOW(),'$blog_desc')";
...
?>
            ...
            <div class="container-fluid">
             ...
             <form action="add_blog.php" method="post" enctype="multipart/form-data">    
                    ...
                    <div class="form-group">
                        <label for="blog_descrp">Blog Info</label>
                        <textarea class="form-control "name="Blog_info" id="" cols="30" rows="5">
                        </textarea>
                    </div>
                    <div class="form-group">
