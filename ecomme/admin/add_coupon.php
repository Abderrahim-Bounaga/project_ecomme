...
if (isset($_POST['add_coupons'])) {
    ...
    $coupon_used = 0;
    $git_coupons = "SELECT * FROM coupons WHERE products_id='$coupon_pro_id' or coupon_code='$coupon_code'";
    ...
    if($check_coupons == 1){
        ...
        $insert_coupon = "INSERT INTO coupons (products_id, coupon_title, coupon_price, coupon_code, coupon_limit, coupon_used,coupon_type) VALUES ('$coupon_pro_id', '$coupon_title', '$coupon_price', '$coupon_code', '$coupon_limit', '$coupon_used','0')";
...
?>
            ...
            <div class="container-fluid">
             ...
             <form action="add_coupon.php" method="post" >    
                    ...
                    <div class="form-group">
                        <label for="coupons_price">coupons pourcentage réduction</label>
                        <input type="number" min="0" max="100" class="form-control" name="coupons_price">
                    </div>
