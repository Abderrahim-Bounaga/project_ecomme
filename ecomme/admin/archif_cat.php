            ...
            <div class="container-fluid">
                ...
                <thead>
                    <tr>
                      ...
                      <tbody>
                      <?php 
                            $query = "SELECT * FROM categories  WHERE Category_archif = '1'" ;
                            ...
                            while ($row = mysqli_fetch_array($load_products_query)) {
                               ...
                               $Category_date = $row['Category_date'];
                                ...
                                echo "<td><a href='archif_cat.php?delete=$Category_id'>add to products</a></td>";
                                echo "</tr>";
                            }
                            ...
                            if (isset($_GET['delete'])) {
                                ...
                                $query_UPDATE = "UPDATE categories SET Category_archif = '0' WHERE Category_id = $deleted_product_id";
