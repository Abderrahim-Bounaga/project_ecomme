            ...
            <div class="container-fluid">
                ...
                <thead>
                    <tr>
                      ...
                      <tbody>
                      <?php 
                            $query = "SELECT * FROM products  WHERE product_archif = '1'" ;
                            ...
                            while ($row = mysqli_fetch_array($load_products_query)) {
                               ...
                               $product_date = $row['product_date'];
                                ...
                                echo "<td><a href='archif_product.php?delete=$product_id'>add to products</a></td>";
                                echo "</tr>";
                            }
                            ...
                            if (isset($_GET['delete'])) {
                                ...
                                $query_UPDATE = "UPDATE products SET product_archif = '0' WHERE product_id = $deleted_product_id";
                                $edit_product_query = mysqli_query($db,$query_UPDATE);

                                header('Location: archif_product.php');
                            }
