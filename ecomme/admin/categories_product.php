...
if (isset($_POST['add_categories'])) {
    ...
    $add_product = "INSERT INTO categories (Category_title,Category_image,Category_desc) VALUES ('$categories_title','$categories_img','$Category_desc')";
...
if (isset($_POST['add_sou_categories'])) {
    ...
    $add_product = "INSERT INTO sou_category (Sou_Category_title,Category_id,sou_categories_img) VALUES ('$sou_categories_title','$categories','$sou_categories_img')";
    $add_product_query = mysqli_query($db,$add_product);
...
function categories()
{
	...
	while($row = $result->fetch_assoc())
	{
		$categories[] = array(
			...
			'Category_id' => sub_categories($row['Category_id']),
		);
	}
...
{	
	...
	$sql = "SELECT Sou_Category_title FROM sou_category  WHERE Category_id = $id ";
	$result = $db->query($sql);
...
<?php foreach($categories as $category){
	...
	<tr>
			...
			if( ! empty($category['Category_id'])){
				echo viewsubcat($category['Category_id']);
			} 
		?></td>
