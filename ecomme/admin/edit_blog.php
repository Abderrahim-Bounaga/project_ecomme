...
$edit_query = "SELECT * FROM blog WHERE blog_id = $pro_id ";
...
if (isset($_POST['edit_blog'])) {
    ...
    $query = "UPDATE blog SET blog_title = '$blog_title' ,blog_img ='$blog_img',blog_date ='$blog_date', blog_desc = '$blog_desc' WHERE blog_id = $b_id ";
