            ...
            <div class="container-fluid">
                ...
                <thead>
                    <tr>
                      ...
                      <tbody>
                      <?php 
                            $query = "SELECT * FROM coupons WHERE coupon_type = '1'" ;
                            ...
                            while ($row = mysqli_fetch_array($load_coupon_query)) {
                                ...
                                $get_product = "SELECT * FROM categories  WHERE Category_id = '$coupon_pro_id'" ;
                                $run_product = mysqli_query($db,$get_product);
                                $row_product = mysqli_fetch_array($run_product);

                                $product_title = $row_product['Category_title'];
