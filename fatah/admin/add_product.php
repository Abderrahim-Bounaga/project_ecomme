...
if (isset($_POST['add_product'])) {
    ...
    $add_product = "INSERT INTO products (Sou_CategoryId,product_CategoryId,product_title,product_image,product_price,product_info,product_desc) VALUES ('$product_cat','$categories','$product_title','$product_img1','$product_price','$product_info','$product_desc')";
